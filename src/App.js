...
export class App extends React.Component {
  ...
  toggleDataModal() {
    this.setState({
      dataModalOpen: !this.state.dataModalOpen
    });
  }
  ...
  render() {
    ...
    this.props.validationList.map(item => {
      ...
      summaryObj.falsePositives += item.falsePositives;
        ...
        <div className="app">
          ...
          <div className="app__info-parent">
            <div className="app__data-display">
              <ChartSection
                data={
                  this.props.validationList[this.state.indexToDisplay] ||
                  summaryObj
                }
              />
              <DataSection
                toggleModal={this.toggleDataModal}
                modalStatus={this.state.dataModalOpen}
                data={
                  this.props.validationList[this.state.indexToDisplay] ||
                  this.props.fullState.validationList
                }
              />
            </div>
